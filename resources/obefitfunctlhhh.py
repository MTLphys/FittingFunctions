...
def fitfunctt(t,Ex1,Ex2,EB,ol21,ol61,oli21,oli61,gm21,gm61,gmi21,gmi61,K,Ad,tau=0e-12):
    ...
    sigeh  = 0.0001 #exciton electron/hole scattering Parameter 
    sigxi  = 0.0001 #exciton impurity scattering Parameter
    sigi   = 0.00000 #impurity impurity scattering Parameter
    sigieh = 0.0001 #impurity electron/hole scattering Parameter
    ...
    Ei21 = E0-EB 
    Ei61 = E0-Ex2-EB 
    print(E21*c.hbar/c.e )
    print(E61*c.hbar/c.e )
    print(Ei21*c.hbar/c.e )
    print(Ei61*c.hbar/c.e )
    ...
    def Pimp(t,tau):
        ...
        sig=0
        for j in range(2):
            sig = sig + 2*PSF*(aterm(t,tau,j+2,j+2,j+2)+bterm(t,tau,j+2,j+2,j+2))
            #for i in range(4):
                #if(i>1):
